    ...
    <div class="col-sm-3">
        <div class="panel">
            ...
            <!-- <li class="list-group-item text-muted">Profile</li> -->
                ...
                "pull-left"><strong>Имя</strong></span>
                <?php echo $res->FNAME .' '.$res->LNAME; ?></li>
                <li class="list-group-item text-right"> 
                <div class="panel-group" id="accordion">   
                  <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"  >Изменить пароль</a>
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active">
                        <a data-toggle="tab" href="#home">Спимок заказов</a>
                    </li> 
                    <li>
                        <a data-toggle="tab" href="#settings">Обновить
                        Профиль</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#wishlist">Желаемые</a>
                    </li>
                </ul>
                        ...
                        <div class="table-responsive" style="margin-top:5%;">
                            ...
                            <a href="#"  title="View list Of ordered products"  class="orderid   "  data-target="#myOrdered" data-toggle="modal" data-id="<?php echo  $result->ORDEREDNUM; ?>"><i class="fa fa-info-circle fa-fw"></i> view orders</a> 
                                            ...
                                            <td class="tooltip-demo">
                                                ...
                                                "tooltip tooltip.top">Посмотреть</span></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    "button">×</button>
                    <h4 class="modal-title" id="myModalLabel">Выбрать 
                    фото.</h4>
                </div>
                ...
                "multipart/form-data" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        type="button">Закрыть</button> <button class=
                        "btn btn-pup" name="savephoto" type="submit">Загрузить
                        Фото</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
