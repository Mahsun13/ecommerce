                    ...
                    <tbody>
                        ...
                        foreach ($cur as $result) { 
                          ...
                          <?php
                           ...
                           ?>
                            <p><h5>Скидка UZS : <?php echo  $result->PRODISCOUNT; ?></h5></p>
                            <p><h5>Цена со скидкой UZS:<?php echo  $result->PRODISPRICE; ?></h5></p> 
                          <?php } ?>
                        <input type="hidden" name="PROPRICE" value="<?php  echo $result->PRODISPRICE; ?>">
                        <input type="hidden" name="PROID" value="<?php  echo $result->PROID; ?>">
                       <button  type="submit"  class="btn btn-primary btn-sm"  name="btnorder">Заказать сейчас!</button>
