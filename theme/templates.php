          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i>+998 93 336 18 30</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> ebuilder@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images\home\lbuild.png" alt="" /></a>
            </div> 
          </div>
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                <li><a href="<?php echo web_root;?>index.php?q=cart"><i class="fa fa-shopping-cart"></i> Корзина</a></li>
                <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  <li><a href="<?php echo web_root?>index.php?q=profile"><i class="fa fa-user"></i>Профиль</a></li>     
                  <li><a   href="<?php echo web_root?>logout.php"><i class="fa fa-lock"></i>Выйти</a></li>
                <?php }else{ ?> 
                <li><a data-target="#smyModal" data-toggle="modal"  href=""><i class="fa fa-lock"></i> Войти</a></li>
              <?php } ?>
              </ul>
            </div>
          </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                <li><a href="<?php echo web_root;?>" class="active">Главная</a></li>
                ...
                <li><a href="<?php web_root?>index.php?q=product">Товары</a></li>
                <li><a href="<?php web_root?>index.php?q=contact">Контакты</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>e</span>-builder</h2>
              <p>Товары для ваших нужд в ремонте и стройке</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>Samarkand,Sam city,Uzbekistan</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#">Часто задаваемы вопросы</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#">Локация магазина</a></li>
