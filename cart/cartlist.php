    ...
    <div class="col-md-12 col-sm-8 content">  
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default panel-shadow">
                    ...
                    <div class="table-responsive">
                         ...
                         <thead>
                           <tr>
                             <td>
                             <div class="culomn4"><div style="float: left; width:90px">Товар </div></div>
                             <div class="culomn4"><div style="float: left; width:250px">Описание</div></div>
                             <div class="culomn4"><div style="float: left; width:200px">Количесвто</div></div>
                             <div class="culomn4"><div style="float: left; width:110px">Цена</div></div>
                             <div class="culomn4"><div style="float: left; width:50px">Итого</div></div>
                             </td>
                           </tr>
                         </thead>                     
                         ...
                         <body onload=" totalprice(); ">
                              ...
                              <form id="form" action="cart/controller.php?action=edit" method="POST"  
                                        onmousemove=" if(QTY.value=='' || QTY.value<1){
                                          ...
                                          TOTAL.value =  totalval.toFixed(2);
                                            ...
                                            alert('Указанное вами количество превышает доступное количество продукта.');
                                              QTY.value = parseInt(availqty.value);
                                            } " > 
                                  ...
                                  <div class="column4">                                  
                                    ...
                                    <div class="form-inline" style="float: left; width:190px">  
                                        ...
                                        <!-- END -->
                                        <a href="cart/controller.php?action=delete&id=<?php echo $result->PRODUCTID; ?>" class="btn btn-link"   >Удалить</a> 
                                        <button type="submit" name="update" class="btn btn-link" >Обновить</button>                                     
                                     </div> 

                                    <!-- <div style="float: right; width:100px"></div> -->
                                     <div style="float: left; width:50px">&nbsp;&nbsp;UZS<span id="price1"><?php echo $result->PRICE; ?></span></div>
                                     <div  id="test" style="float: right; width:50px">UZS<output name="TOTAL" for="QTY price"></output></div>                                     
                                  </div>
                              </form> 
                            ...
                            <?php  
                                  ...
                                  echo "<h1>В корзине нет товара.</h1>";
                               } 
                            ?>
                              </div> <!--Scrollbar--> 
                            ...
                            <tr >  
                            <td>                               
                             <div class="culomn4"><div style="float: right;"><h1> Итоговая цена : UZS<span id="sum">0</span></h1></div></div>
                            </td>                        
                ...
                <a href="index.php?page=2" class="btn btn-default pull-left"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Добавить новый заказ</strong></a>
                <a href="index.php?page=7" name="proceed"  class="btn btn_fixnmix pull-right"   ><strong>Продолжить и отправить</strong> <span class="glyphicon glyphicon-chevron-right"></span></a> 
