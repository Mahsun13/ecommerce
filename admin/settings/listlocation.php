<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Список локаций  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Новый</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
			  ...
			  <tbody>
				  	<?php 
						...
						foreach ($cur as $result) { 
				  		...
				  		echo '<td> UZS '.  number_format($result->DELPRICE,2).'</td>'; 
				  		echo
				  		 '<td align="left">
