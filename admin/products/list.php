<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Список продуктов  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Новый</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
			  ...
			  <tbody>
				    ...
				    echo '<td style="padding:0px;">
				  		...
				  		echo '<td> UZS '.  number_format($result->PRODISCOUNT,0).'</td>';
				  		echo '<td> UZS '.  number_format($result->PRODISPRICE,2).'</td>';
				...
				<div class="btn-group">
				  ...
				  <button type="submit" class="btn btn-default" name="delete"><i class="fa fa-trash fw-fa"></i> Удалить выбранное</button>
				</div>
				</div>
				</form>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Фото.</h4>
                                </div>
