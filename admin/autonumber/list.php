...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Список  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Новый</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				  ...
				  <thead>
				  	<tr> 
				  		<th>
				  		 ...
				  		 Нумерация</th> 
				  		  <th>Ключ</th>
				  		 <th width="10%" align="center">Активность</th>
				  	</tr>	
				  </thead> 
				  <tbody>
				  	<?php 
