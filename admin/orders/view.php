...
<?php  
    ...
    ?>
	 ...
	 <div class="row">
        ...
        <div class="col-md-6">
            <h1><strong>Данные покупателя</strong></h1><br>
...
<?php  
	...
	?>
        ...
        <div class="col-md-6">
            <h1><strong>Данные товара</strong></h1><br>
            <div class="table-responsive">
            <table class="table table-condensed table-responsive table-user-information">
                <tbody>
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo ': '.$singleproduct->PRICE; ?> UZS 
                        </td>
                    </tr>
...
<?php } ?>
                        ...
                        <td>
							...
							<a href="index.php" class="btn btn_fixnmix" name="back" type="submit">Назад</a>
                        </td>
                        <td>
