      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">  
            <fieldset>  
              <legend><h2 class="text-left">Данные заказа</h2></legend>

            <table class="fixnmix-table">
          
              <tbody>
                <tr>
                <td width="100px">Имя </td><td  width="350px"> 
                ...
                <td width="100px">Фамилия</td><td> <input  id="LASTNAME" name="LASTNAME"  class="form-control input-sm"  type="text" value="<?php echo isset($_SESSION['LASTNAME'])? $_SESSION['LASTNAME'] : ""; ?>"></td>
                </tr>
                <tr>
                <td>Адрес </td><td> <input  id="ADDRESS" name="ADDRESS"  class="form-control input-sm"  type="text" value="<?php echo isset($_SESSION['ADDRESS'])? $_SESSION['ADDRESS'] : ""; ?>"></td>
                 <td  width="100px">Контакты </td><td  width="350px"> <input  id="CONTACTNUMBER" name="CONTACTNUMBER"  class="form-control input-sm"  type="number" value="<?php  echo isset($_SESSION['CONTACTNUMBER'])? $_SESSION['CONTACTNUMBER'] : "";?>"></td>
              </tr>        
              </tbody> 
            ...
            <div class="container"> 
              <div class="row"> <h3  align="right" margin-right="20%">Итоговая цена : UZS <span  id="sum">0.00</span></h3></div>  
                </div>
                ...
                ?>
                 <input  id="ORDERNUMBER" name="ORDERNUMBER"   type="hidden" value="<?php echo $res->AUTO; ?>"> 
                  <a href="index.php?view=addtocart" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Посмотреть корзину</strong></a>
                <button   name="submitorder"  id ="submitorder" class="btn btn_fixnmix pull-right"  onclick="validatedate()" ><strong>Сохранить заказ</strong> <span class="glyphicon glyphicon-chevron-right"></span></button> 
