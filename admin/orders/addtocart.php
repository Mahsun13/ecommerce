      ...
      <div class="">
        <div class="panel panel-default">
          <div class="panel-body">  
            <fieldset>  
              <legend><h2 class="text-left">Сисок</h2></legend>
            <form action="index.php?view=orderdetails" method="post">
                          ...
                          ?>
                                    <tr>
                                      ...
                                      <input type="NUMBER" data-id="<?php echo $result->PRODUCTID;  ?>" class="qty" name="QTY<?php echo $result->PRODUCTID;  ?>" id="QTY<?php echo $result->PRODUCTID; ?>"  value="<?php echo $_SESSION['fixnmix_cart'][$i]['qty'] ?>"/>
                                        ...
                                        <td>
                                        UZS <output id="Osubtot<?php echo $result->PRODUCTID ?>"><?php echo   $_SESSION['fixnmix_cart'][$i]['price']; ?></output>
                                        </td>
                                      <!-- hidden textbox -->
                                     ...
                                     <td>   <a href="controller.php?action=cartdelete&id=<?php echo $result->PRODUCTID; ?>"  data-id="<?php echo $result->PRODUCTID ?>"   class="delete btn btn-danger btn-xs">Удалить</a></td> 
                                    </tr>
                          <?php
                            }
              ...
              <table>
           <tfoot  >
                    <div ><strong><h1 align="right" >Итоговая цена : UZS <span id="sum">0</span></h1></strong></td></div> 
                ...
                <a href="index.php?view=addorder" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;<strong>Добавить ещё товар</strong></a>
               <button type="submit" name="proceed" class="btn btn_fixnmix pull-right"   ><strong>Продолжить и отправить</strong> <span class="glyphicon glyphicon-chevron-right"></span></button> 
            </form>
       </fieldset>
          </div>    
        </div>
