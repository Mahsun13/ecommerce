              ...
              <tbody>
                <?php  
                  ...
                  foreach ($cur as $result) {
                    ...
                    echo '<td align="center"> UZS '. $result->PRICE.'</td>';
                    // echo '<td align="left">
                    // <a href="controller.php?action=cartadd&id='.$result->PRODUCTID.'&price='.$result->PRICE.'" class="btn btn_fixnmix btn-xs"><strong>Add to Cart</strong></a></td>';
                      echo '<td align="left">
                    <a href="index.php?view=addtocart"   data-id="'.$result->PRODUCTID.'" class="btn btn_fixnmix btn-xs MAINorder"><strong>В корзиину</strong></a></td>';
                    //  echo '<td align="left">
