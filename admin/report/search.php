...
<td ><strong>Номер закза</strong></td>
...
<tr> <h4 align="right"> Общая цена : UZS <?php echo isset( $overall) ? $overall : 0; ?></h4>  </tr>
	
</tfoot>
</table>
</span>
<button onclick="tablePrint();" class="btn btn_fixnmix"><span class="glyphicon glyphicon-print"></span>Печать  </button>
