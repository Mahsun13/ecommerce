              ...
              <div class="row">  
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                      ...
                      <li>Тип - <?php echo $cur->PRODESC; ?></li>
                      <li>Цена - UZS <?php echo $cur->PROPRICE; ?></li>
                       <?php if($cur->PRODISCOUNT>0){ ?>
                        <li>Скидка - <?php echo $cur->PRODISCOUNT; ?> % </li> 

                        <li>Со скидкой - UZS <?php echo $cur->PRODISPRICE; ?> </li> 
                        <?php } ?>
                      <li>В наличии - <?php echo $cur->PROQTY; ?></li>
                    </ul> 
                    <button class="btn btn-pup"  name="btnorder" type="Submit">Заказать сейчас</button> 
                    <button class="btn btn-default" id="btn_close" data-dismiss="modal" type="button">Закрыть</button> 
