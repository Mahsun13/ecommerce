            ...
            <div class="row">   
                <div class="col-sm-8">
                    <div class="contact-form">
                        ...
                        <form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
                            ...
                            <div class="form-group col-md-12">
                                <textarea name="message" id="message" required="required" class="form-control" rows="8" placeholder="Ваш текст"></textarea>
                            </div>                        
                            <div class="form-group col-md-12">
                ...
                <div class="col-sm-4">
                    <div class="contact-info">
                        ...
                        <address>
                            <p>E-builder Inc.</p>
                            <p>Saamarkand city,Uzbekistan </p>
                            <p>Samarkand UZb</p>
                            <p>Mobile: +998 93 336 18 30</p>
                            <p>Fax: 1-1233-4312412</p>
                            <p>Email: info@e-builder.com</p>
                        </address>
